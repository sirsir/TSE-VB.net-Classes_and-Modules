...
#End Region
    ...
    Public Sub New()
        ...
        'Dim arrNetNodeUnit As String() = appSet.GetValue("FinsAddress", GetType(String)).Split(".")

        Dim arrNetNodeUnit As String() = CStr(varFromJson.Item("PLC").Item("FinsAddress")).Split(".")
